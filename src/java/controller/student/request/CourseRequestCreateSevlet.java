 ...
 * @author Admin
 */
@WebServlet(name = "CourseRequestCreateSevlet", urlPatterns = {"/createCourseRequest"})
public class CourseRequestCreateSevlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CourseRequestCreateSevlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CourseRequestCreateSevlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
