 ...
 * @author Admin
 */
@WebServlet(name = "DiscussionMyResponseServlet", urlPatterns = {"/myResponseDiscussion"})
public class DiscussionMyResponseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DiscussionMyResponseServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DiscussionMyResponseServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int pageNumber = discussionService.getPageNumberForPost(itemId, userId, pageSize);
