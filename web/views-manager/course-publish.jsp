                                ...
                                <td>
                                    <div class="course-info">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <img src="${pageContext.request.contextPath}/views-manager/icon/default.png"
                                                     alt="Thumbnail" class="thumbnail">
                                            </c:otherwise>
                                        </c:choose>
                                    ...
                                    <div class="teacher-info">
                                        <c:choose>
                                            <c:when test="${not empty course.createdBy.user.profilePicture}">
                                                <img src="${pageContext.request.contextPath}/${course.createdBy.user.profilePicture}"
                                                     alt="Avatar" class="avatar">
                                            </c:when>
                                            <c:otherwise>
                                                <img src="${pageContext.request.contextPath}/views-manager/icon/logo.png"
                                                     alt="Avatar" class="avatar">
                                            </c:otherwise>
                                        </c:choose>
