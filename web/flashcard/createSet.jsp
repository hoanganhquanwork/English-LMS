...
<<<<<<< HEAD
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/flashcard-styles.css?v=322">
...
<template id="cardTemplate">
    <div class="card-entry" data-index="__INDEX__">
        ...
        <div class="card-actions">
            <button class="remove-card-btn" type="button" onclick="removeCard(this)">🗑</button>
        </div>
    </div>
</template>
