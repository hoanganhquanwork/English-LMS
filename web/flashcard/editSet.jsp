                ...
                <form action="set" method="post" onsubmit="return confirm('Bạn có chắc muốn lưu thay đổi?')">
                    ...
                    <div class="input-group">
                        ...
                        <select id="status" name="status" class="status-select">
                            <option value="private"  ${set.status == 'private' ? 'selected' : ''}> Private (Chỉ mình tôi)</option>
                            <option value="public"   ${set.status == 'public'  ? 'selected' : ''}> Public (Mọi người đều xem được)</option>
                        </select>
                    </div>
            </div>
