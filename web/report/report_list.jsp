...
<%
    ...
    // Thiết lập header, css, layout theo role
    String headerPath = "";
    String cssPath = "";
    String bodyClass = "";
    String wrapperStart = "";
    ...
    if ("Parent".equals(role)) {
        headerPath = "../parent/parent_header.jsp";
        cssPath = ctx + "/css/parent_link_approval.css";
        bodyClass = "bg-light";
                        ...
                        <tbody>
                            <c:forEach var="r" items="${reports}">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${fn:length(r.adminNote) > 2000}">
                            ...
                            <c:if test="${empty reports}">
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4">Chưa có báo lỗi nào.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
